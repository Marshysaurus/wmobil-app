  ...
  void showRangePicker() async {
    ...
    if (picked != null) {
      if (picked.length == 1) {
        ...
        cancellationProducts.fetchCancellationProducts(
          ...
          child: pw.Column(
            children: [
              ...
              pw.Row(
                ...
                children: [
                  pw.Text(
                    'Resumen de productos en cancelaciones',
        ...
        SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 8),
              StreamBuilder(
                  stream: cancellationProducts.stream$,
                  builder: (context, snapshot) {
                    ...
                    if (productos.isEmpty) {
                      ...
                      return HighlightedPreviewCard(
                        ...
                        cardInformationData: "Total Precio",
                      );
                    }
                  }),
            ],
