      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              Container(
                child: Text("Razón:", style: wTextStyle500),
                margin: EdgeInsets.only(right: 5),
              ),
              Flexible(
                child: Container(
                  child: Text('${account["razon_cancelado"]}',
                      style: wTextStyle400, overflow: TextOverflow.ellipsis, maxLines: 2),
                  margin: EdgeInsets.only(right: 5),
                ),
              ),
            ],
