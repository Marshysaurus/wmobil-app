...
class DiscountsProducts {
  ...
  fetchDiscountProducts(String startDate, String endDate) async {
    ...
    dynamic discountProductsData = await getUserRestaurantProductsDiscounts(
        _products.value["id"], startDate, endDate);

    _products.add({...discountProductsData, "loading": false, "id" : _products.value["id"], "feedback": "Solicitud completada"});
  }
}
